...
public class JoongsikPanel_이은지 extends JPanel {
	...
	public JoongsikPanel_이은지() throws Exception {
		...
		joongsikImageLB1.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		...
		joongsikImageLB2.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		...
		joongsikImageLB3.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
