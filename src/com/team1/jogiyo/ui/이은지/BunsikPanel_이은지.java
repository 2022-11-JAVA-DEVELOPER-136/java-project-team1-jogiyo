...
public class BunsikPanel_이은지 extends JPanel {
	...
	public BunsikPanel_이은지() throws Exception {
		...
		bunsikPanel1.setBounds(10, 12, 348, 150);
		add(bunsikPanel1);
		...
		bunsikNameLB1.setBounds(235, 51, 109, 30);
		...
		bunsikPriceLB1.setBounds(269, 91, 75, 24);
		...
		bunsikPanel2.setBounds(10, 173, 348, 150);
		add(bunsikPanel2);
		...
		bunsikNameLB2.setBounds(234, 50, 109, 30);
		...
		bunsikPriceLB2.setBounds(268, 90, 75, 24);
		...
		bunsikPanel3.setBounds(9, 336, 348, 150);
		add(bunsikPanel3);
		...
		bunsikNameLB3.setBounds(233, 48, 109, 30);
		...
		bunsikPriceLB3.setBounds(267, 88, 75, 24);
