...
--제품번호 2번 2마리
insert into order_item(oi_no,oi_qty,o_no,p_no)
    values(ORDER_ITEM_OI_NO_SEQ.nextval,2,ORDERS_O_NO_SEQ.currval,2); --ORDER_ITEM_OI_NO_SEQ 시퀀스 만든이유 복합키로 안만드려고
...
--1.orders insert
insert into orders(o_no,o_desc,o_date,o_price,userid)
    values(ORDERS_O_NO_SEQ.nextval,'퍼그외6마리',sysdate,1550000,'guard1');
